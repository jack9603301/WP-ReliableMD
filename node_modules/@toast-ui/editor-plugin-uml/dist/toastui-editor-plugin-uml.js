...
module.exports = require("plantuml-encoder");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return umlPlugin; });
/* harmony import */ var plantuml_encoder__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
...
function umlPlugin(editor, options) {
  ...
  var _options = options,
      _options$rendererURL = _options.rendererURL,
      rendererURL = _options$rendererURL === void 0 ? DEFAULT_RENDERER_URL : _options$rendererURL;
  /**
  ...
  function plantUMLReplacer(umlCode) {
    ...
    try {
      if (!plantuml_encoder__WEBPACK_IMPORTED_MODULE_0___default.a) {
        throw new Error('plantuml-encoder dependency required');
      }

      renderedHTML = "<img src=\"" + rendererURL + plantuml_encoder__WEBPACK_IMPORTED_MODULE_0___default.a.encode(umlCode) + "\" />";
    } catch (err) {
